...
function handledResizable(resizer, resizee, options) {
    ...
    map.set(resizer, {
        ...
        movement: Object.assign({ x: 1, y: 1 }, options === null || options === void 0 ? void 0 : options.movement),
        ...((options === null || options === void 0 ? void 0 : options.hooks) ? { hooks: options.hooks } : {}),
    });
...
function _dragStart(event) {
    ...
    // custom hook //
    if (((_a = resizer_data.hooks) === null || _a === void 0 ? void 0 : _a.resizeStart) && ((_b = resizer_data.hooks) === null || _b === void 0 ? void 0 : _b.resizeStart(event, resizer, resizer_data)) === false)
        return;
...
function _drag(event) {
    ...
    const resizer_data = map.get(resizer);
    // custom hook //
    if (((_a = resizer_data.hooks) === null || _a === void 0 ? void 0 : _a.resize) && ((_b = resizer_data.hooks) === null || _b === void 0 ? void 0 : _b.resize(event, resizer, resizer_data)) === false)
        return;
...
function _dragEnd(event) {
    ...
    // custom hook //
    if ((_a = resizer_data.hooks) === null || _a === void 0 ? void 0 : _a.resizeEnd) {
        (_b = resizer_data.hooks) === null || _b === void 0 ? void 0 : _b.resizeEnd(event, resizer, resizer_data);
    }
}
